...
// NewArticleUsecase creates a new instance of ArticleUsecase. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewArticleUsecase(t testing.TB) *ArticleUsecase {
	mock := &ArticleUsecase{}
	mock.Mock.Test(t)
